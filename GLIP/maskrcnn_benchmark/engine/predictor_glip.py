...
class GLIPDemo(object):
    ...
    def inference(self, original_image, original_caption, custom_tokens_positive=None):
        predictions = self.compute_prediction(original_image, original_caption, custom_entity=custom_tokens_positive)
    ...
    def compute_prediction(self, original_image, original_caption, custom_entity = None):
        ...
        if isinstance(original_caption, list):
            ...
            if custom_entity is None:
                tokens_positive = self.run_ner(original_caption)    # List([[pos0,pos1],..,[pos n-1, pos n]], [], ..)
            else:
