...
class DatasetCatalog(object):
    DATASETS = {
        ...
        # omnilabel
        "omnilabel_val_1.4": {"img_dir": "omnilabel/imgs", "ann_file": "omnilabel/dataset_all_val_v0.1.4.json"},
        #
        "omnilabel_val_1.3": {"img_dir": "omnilabel/imgs", "ann_file": "omnilabel/dataset_all_val_v0.1.3.json"},
        "omnilabel_val_1.3_coco": {"img_dir": "omnilabel/imgs", "ann_file": "omnilabel/dataset_all_val_v0.1.3_coco.json"},
        "omnilabel_val_1.3_o365": {"img_dir": "omnilabel/imgs", "ann_file": "omnilabel/dataset_all_val_v0.1.3_object365.json"},
        "omnilabel_val_1.3_oi_v5": {"img_dir": "omnilabel/imgs", "ann_file": "omnilabel/dataset_all_val_v0.1.3_openimagesv5.json"},
    }
